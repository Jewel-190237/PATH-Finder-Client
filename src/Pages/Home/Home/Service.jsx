...
//                 <div
//                     className=" mx-auto p-6 md:p-8 lg:p-12 xl:p-[60px] my-5 md:my-8 lg:my-[90px] xl:my-[110px] "
//                 >
//                     <h1 className="font-roboto text-lg font-extrabold md:text-xl lg:text-2xl text-center mx-auto uppercase ">Earn Big Through</h1>
...
//                         Premium  <span className="text-transparent bg-clip-text bg-[linear-gradient(90deg,#3F3FDE_0.07%,#FF0DEF_32.88%)]">Services</span>, Currency <br /> Exchange, and Phone Recharges!
//                     </h1>
...
//                 <div className="bg-[#20010D] max-w-[365px] h-full rounded-[30px]">
//                     <div className="relative   rounded-lg shadow-lg mx-auto">
//                         {/* Icon Section */}
//                         <div className="absolute -top-8 left-1/2 transform -translate-x-1/2  flex items-center justify-center shadow-lg">
//                             <img
//                                 src="/src/assets/service/facebook.png"
//                                 alt="Facebook"
//                                 className="w-28 h-28"
//                             />
//                         </div>
...
//                             style={{
//                                 backgroundImage: "url('/src/assets/service/FB.png')", // Replace with your image path
//                             }}
//                         >
//                             <div className=" w-full py-3 px-4 rounded-md flex items-center justify-between">
//                                 {/* Text */}
//                                 <p className="text-white text-sm md:text-base font-medium">
//                                     Get rewards by following us on Facebook
//                                 </p>
