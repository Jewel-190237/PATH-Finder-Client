...
const AxisPoint = () => {
  ...
  return (
    < div
      ...
      className="bg-cover bg-center text-white pt-16 sm:pt-40 pb-96 px-5"
    >
      <div className="max-w-[1320px] mx-auto">
        ...
        <div className="p-6 mt-20 -mb-28 border-[1px] border-[#F5F8FC] rounded-t-[60px]">
          <div
            className="p-8 sm:p-12  rounded-t-[40px]  shadow-lg mx-auto border-[1px] border-[#F5F8FC]"
            ...
            {selectedUsers?.map((item, index) => (
              ...
              >
                <div className="flex  mt-3 items-center">
                  ...
                  <p className="text-white whitespace-pre   font-medium">{item?.name}</p>
                </div>
